...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "SpiceNetwork") type = SpiceNetwork;
    if(strType == "SpiceNetworkVariable") type = SpiceNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == SpiceNetwork) s = "SpiceNetwork";
    if(type == SpiceNetworkVariable) s = "SpiceNetworkVariable";
