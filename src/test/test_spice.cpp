...
#define BOOST_TEST_MODULE Spice Test Suite

#include "test_spice.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_spice_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
