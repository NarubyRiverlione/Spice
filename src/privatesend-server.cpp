...
void CPrivateSendServer::ProcessMessage(CNode* pfrom, std::string& strCommand, CDataStream& vRecv, CConnman& connman)
{
    ...
    if(fLiteMode) return; // ignore all Spice related functionality
...
/*
    ...
    allow endless transaction that would bloat Spice and make it unusable. To
