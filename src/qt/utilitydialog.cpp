    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Spice Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Spice Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  spice-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Spice in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 SPICE, 0.1 SPICE, 1 SPICE and 10 SPICE -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://spicepay.atlassian.net/wiki/display/DOC/PrivateSend\">https://spicepay.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Spice Core is shutting down...") + "<br /><br />" +
