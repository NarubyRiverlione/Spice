    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Dune Spice") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Dune Spice"), this);
    aboutAction->setStatusTip(tr("Show information about Dune Spice"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Dune Spice"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Dune Spice help message to get a list with possible Dune Spice command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Dune Spice client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Dune Spice"); // default title
