    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Spice Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and spice: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Spice Core"), this);
    aboutAction->setStatusTip(tr("Show information about Spice Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Spice Core"));
    ...
    openAction->setStatusTip(tr("Open a spice: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Spice Core help message to get a list with possible Spice Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Spice Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Spice network", "", count));
    } else {
...
{
    QString strTitle = tr("Spice Core"); // default title
