...
This mechanism has been integrated into Bitcore-Node-Spice which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/spicepay/insight-api-spice#web-socket-api](https://github.com/spicepay/insight-api-spice#web-socket-api)
* API: [https://github.com/spicepay/insight-api-spice#instantsend-transactions](https://github.com/spicepay/insight-api-spice#instantsend-transactions)
...
By default, the Spice Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Spice Core daemon:
