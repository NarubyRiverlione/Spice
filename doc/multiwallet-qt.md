...
Only requiring some minor changes is spice.cpp.
...
Changes to spice.cpp
----------------------
spice.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
